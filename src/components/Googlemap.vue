    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        const positionCompany = {
          lngCompany: 98.96717131662662,
          latCompany: 18.78593940199299,
        };
        ...
        const lat1 = positionUser.latUser;
        const lat2 = positionCompany.latCompany;
        const lon1 = positionUser.lngUser;
        const lon2 = positionCompany.lngCompany;
